...
/**
 * Тіло {@code POST /api/v1/evaluate-preview}. Імена полів — частина API:
 * {@code environment} (НЕ environmentKey), {@code flagKey}, {@code context}.
 *
 * <p>{@code context} — прямо core-record {@link EvaluationContext} (той самий
 * прийом, що з Rule/Rollout): JSON {@code {"userKey": "...",
