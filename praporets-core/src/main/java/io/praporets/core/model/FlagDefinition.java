 ...
 * дає {@code jsonValue = null} у результаті, не виключення.
 *
 ...
 * {@code rollout} — {@code null}, якщо відсоткового розподілу немає.
 *
 * @param key            глобально унікальний ключ флага (напр. {@code "checkout.new-payment-flow"})
 * @param enabled        false → завжди {@code offVariant}, правила не перевіряються
 ...
 * @param rules          впорядковані правила таргетингу; перше збіжне виграє
